...
export const Networks: {[key:string]: NetworkConfig} = {
  sepolia: { ...sepolia,
    ...
    contracts: { ...sepolia.contracts,
      p2pix: { address: import.meta.env.VITE_SEPOLIA_P2PIX_ADDRESS as `0x${string}` } },
    tokens: {
      BRZ: { address: import.meta.env.VITE_SEPOLIA_TOKEN_ADDRESS as `0x${string}` } },
  ...
  rootstock: { ...(isTestnetEnvironment() ? rootstockTestnet : rootstock),
    ...
    contracts: { ...(isTestnetEnvironment() ? rootstockTestnet.contracts : rootstock.contracts),
      p2pix: { address: import.meta.env.VITE_RSK_P2PIX_ADDRESS as `0x${string}` } },
    tokens: {
